...
if (hacker1chars > hacker2chars) {
  console.log(
    "The driver has the longest name, it has " + hacker1chars + " characters."
  );
} else if (hacker2chars > hacker1chars) {
  console.log(
    "The driver has the longest name, it has " + hacker2chars + " characters."
  );
} else {
  console.log(
    " Wow, you both have equally long names, " + hacker1chars + " characters!."
  );
}
